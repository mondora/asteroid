...
* Small footprint. The library is about ~10Kb minified. It depends on ddp.js (~5Kb minified), and a q-compatible promise library (q is ~23Kb minified, for a lightweight alternative, check out my fork of [ayepromise](https://github.com/mondora/ayepromise), which is ~2Kb minified).
